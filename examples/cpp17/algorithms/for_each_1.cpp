...
struct accel_executor
{
  ...
  accel_executor<algorithm::extensions::for_each_1_t> require_concept(
      algorithm::extensions::for_each_1_t) const noexcept
  {
    return {};
  }
  ...
  template <class ForwardIt, class UnaryFunction2,
    std::enable_if_t<
      ...
      >
    >* = nullptr>
  void for_each_1(ForwardIt first, ForwardIt last, UnaryFunction2 f) const
  {
...
struct third_party_adapter
{
  ...
  static constexpr algorithm::extensions::for_each_1_t query(
...
third_party_adapter require_concept(
    ...
    algorithm::extensions::for_each_1_t)
{
  return {ex};
}
...
int main()
{
  ...
  algorithm::for_each_1(ex1,
      vec.begin(), vec.end(),
      [](auto x){ std::cout << x << "\n"; });

  algorithm::for_each_1(ex2,
      vec.begin(), vec.end(),
      [](auto x){ std::cout << x << "\n"; });

  algorithm::for_each_1(ex3,
      vec.begin(), vec.end(),
      [](auto x){ std::cout << x << "\n"; });
}
